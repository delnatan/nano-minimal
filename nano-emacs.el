...
;;
;; History:
;; Daniel elnatan, April 2026. Modified original code to use iosevka
;;                             Removed mini-buffer formatting
...
(when (eq system-type 'darwin)
  ...
  (setq mac-option-modifier       'meta   ;; Option = Meta, matches Alt on standard keyboard
        mac-right-option-modifier 'meta
        mac-command-modifier      'super  ;; Command = Super, keeps Mac shortcuts available
        mac-right-command-modifier 'hyper ;; Right Command = extra modifier real estate
